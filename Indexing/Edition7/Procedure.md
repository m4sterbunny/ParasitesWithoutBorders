...
4. The next cell "EDIT FILE NAMES and FRONT MATTER" is where you need to specify where you uploaded the index file in your Google Drive, the name you want for the clean file and how many roman numeral pages there are.
    ...
    * the full file path will look something like this: '/content/gdrive/My Drive/Technobunnies/preclean_20190424.txt'
    * If there are more than 12 pages of front matter more roman numerals need to be added
5. Press the play button the next two cells
